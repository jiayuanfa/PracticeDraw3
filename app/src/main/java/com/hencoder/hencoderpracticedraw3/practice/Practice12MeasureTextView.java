...
public class Practice12MeasureTextView extends View {
...

    {
        ...
        measured1Text = paint1.measureText(text1);
        measured2Text = paint2.measureText(text2);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text2, 50 + measured1Text, 200, paint2);
        canvas.drawText(text3, 50 + measured1Text + measured2Text, 200, paint1);
    }
}
